...
/-!
# Scalar nonuniform Berry--Esseen theorem
...
type, probability space, family, and threshold.  This is the frozen scalar theorem in `SPEC.md`,
obtained from Chen--Shao (2005), Section 6 together with the standard truncation and reflection
reductions. -/
